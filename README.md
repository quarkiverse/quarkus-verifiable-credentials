...
[![Version](https://img.shields.io/maven-central/v/io.quarkiverse.verifiable-credentials/quarkus-verifiable-credentials?logo=apache-maven&style=flat-square)](https://search.maven.org/artifact/io.quarkiverse.verifiable-credentials/quarkus-verifiable-credentials)
...
For more details, check the complete [documentation](https://quarkiverse.github.io/quarkiverse-docs/quarkus-verifiable-credentials/dev/index.html).
